...
<style>
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .verify{font-family:Arial,sans-serif;font-size:10px;color:#6b7280;text-align:center;margin-top:18px;line-height:1.6}
...
<div class="wrap">
  ...
  <div class="inner">
    ...
    ${verification ? `<div class="verify"><div><strong>Certificate ID:</strong> ${verification.certificateId}</div><div><strong>Verify:</strong> ${verification.verifyUrl}</div></div>` : ''}
  </div>
...
<style>
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .verify{padding:0 32px 18px;font-size:10px;color:#6b7280;line-height:1.6;text-align:center}
  .verify strong{color:#111827}
