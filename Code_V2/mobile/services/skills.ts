...
export const skillService = {
    ...
    setRequiredSkills: (opportunityId: string, skillIds: string[]): Promise<void> =>
        api.put(`/api/opportunities/${opportunityId}/required-skills`, { skillIds }).then(() => { }),
};
